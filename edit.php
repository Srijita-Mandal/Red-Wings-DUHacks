...
<body>
  ...
  <div class="card-body">
    ...
    <form action="edit_script.php" method="POST">
        ...
        <input type="text" class="form-control" name="name" id="name" placeholder="<?php echo $row1[0] ?>" required>
        <!-- </form> -->
        </p>
        ...
        <!-- <form action="edit_script.php" method="POST"> -->
        <input type="text" class="form-control" name="address" id="address" placeholder="<?php echo $row2[0] ?>" required>
        </p>
    </form>
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item" style="display:flex;justify-content:center;"><button type="submit" value="submit" class="btn btn-primary">save</button></li>
    <li class="list-group-item"><h5>Donation history</h5>
            <table class="table table-striprd table-responsive">
                <?php
                $query5="SELECT donation_to FROM single_donor WHERE email='$email'";
